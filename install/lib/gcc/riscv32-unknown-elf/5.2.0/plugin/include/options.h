...
enum opt_code
{
  ...
  OPT_mEci = 1138,                           /* -mEci */
  OPT_mFC_ = 1139,                           /* -mFC= */
  OPT_mL1Cl_ = 1140,                         /* -mL1Cl= */
  OPT_mL1Fc_ = 1141,                         /* -mL1Fc= */
  OPT_mL2_ = 1142,                           /* -mL2= */
  OPT_mPE_ = 1143,                           /* -mPE= */
  OPT_mWci = 1144,                           /* -mWci */
  OPT_march_ = 1145,                         /* -march= */
  OPT_matomic = 1146,                        /* -matomic */
  OPT_mbranch_cost_ = 1147,                  /* -mbranch-cost= */
  OPT_mchip_ = 1148,                         /* -mchip= */
  OPT_mcmodel_ = 1149,                       /* -mcmodel= */
  OPT_mconf_ = 1150,                         /* -mconf= */
  OPT_mcpu_ = 1151,                          /* -mcpu= */
  OPT_mfdiv = 1152,                          /* -mfdiv */
  OPT_mhard_float = 1153,                    /* -mhard-float */
  OPT_mlra = 1154,                           /* -mlra */
  OPT_mmemcpy = 1155,                        /* -mmemcpy */
  OPT_mmuldiv = 1156,                        /* -mmuldiv */
  OPT_mnativeomp = 1157,                     /* -mnativeomp */
  OPT_mno_fdiv = 1158,                       /* -mno-fdiv */
  OPT_mnoabs = 1159,                         /* -mnoabs */
  OPT_mnoaddsubnormround = 1160,             /* -mnoaddsubnormround */
  OPT_mnoball = 1161,                        /* -mnoball */
  OPT_mnobitop = 1162,                       /* -mnobitop */
  OPT_mnoclip = 1163,                        /* -mnoclip */
  OPT_mnofinduct = 1164,                     /* -mnofinduct */
  OPT_mnohwdiv = 1165,                       /* -mnohwdiv */
  OPT_mnohwloop = 1166,                      /* -mnohwloop */
  OPT_mnoindregreg = 1167,                   /* -mnoindregreg */
  OPT_mnomac = 1168,                         /* -mnomac */
  OPT_mnominmax = 1169,                      /* -mnominmax */
  OPT_mnomulmacnormround = 1170,             /* -mnomulmacnormround */
  OPT_mnopartmac = 1171,                     /* -mnopartmac */
  OPT_mnopostmod = 1172,                     /* -mnopostmod */
  OPT_mnosext = 1173,                        /* -mnosext */
  OPT_mnoshufflepack = 1174,                 /* -mnoshufflepack */
  OPT_mnoslet = 1175,                        /* -mnoslet */
  OPT_mnovect = 1176,                        /* -mnovect */
  OPT_mplt = 1177,                           /* -mplt */
  OPT_mrvc = 1178,                           /* -mrvc */
  OPT_mrvstd = 1179,                         /* -mrvstd */
  OPT_msave_restore = 1180,                  /* -msave-restore */
  OPT_msloop = 1181,                         /* -msloop */
  OPT_msmall_data_limit_ = 1182,             /* -msmall-data-limit= */
  ...
  OPT_r = 1214,                              /* -r */
  OPT_remap = 1215,                          /* -remap */
  OPT_s = 1216,                              /* -s */
  OPT_s_bc_abi = 1217,                       /* -s-bc-abi */
  OPT_save_temps = 1218,                     /* -save-temps */
  OPT_save_temps_ = 1219,                    /* -save-temps= */
  OPT_shared = 1220,                         /* -shared */
  OPT_shared_libgcc = 1221,                  /* -shared-libgcc */
  /* OPT_specs = 1222, */                    /* -specs */
  OPT_specs_ = 1223,                         /* -specs= */
  OPT_static = 1224,                         /* -static */
  OPT_static_libasan = 1225,                 /* -static-libasan */
  OPT_static_libgcc = 1226,                  /* -static-libgcc */
  OPT_static_libgcj = 1227,                  /* -static-libgcj */
  OPT_static_libgfortran = 1228,             /* -static-libgfortran */
  OPT_static_libgo = 1229,                   /* -static-libgo */
  OPT_static_liblsan = 1230,                 /* -static-liblsan */
  OPT_static_libmpx = 1231,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1232,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1233,               /* -static-libstdc++ */
  OPT_static_libtsan = 1234,                 /* -static-libtsan */
  OPT_static_libubsan = 1235,                /* -static-libubsan */
  /* OPT_std_c__03 = 1236, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1237, */                /* -std=c++0x */
  OPT_std_c__11 = 1238,                      /* -std=c++11 */
  OPT_std_c__14 = 1239,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1240, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1241, */                /* -std=c++1y */
  OPT_std_c__1z = 1242,                      /* -std=c++1z */
  OPT_std_c__98 = 1243,                      /* -std=c++98 */
  OPT_std_c11 = 1244,                        /* -std=c11 */
  /* OPT_std_c1x = 1245, */                  /* -std=c1x */
  /* OPT_std_c89 = 1246, */                  /* -std=c89 */
  OPT_std_c90 = 1247,                        /* -std=c90 */
  OPT_std_c99 = 1248,                        /* -std=c99 */
  /* OPT_std_c9x = 1249, */                  /* -std=c9x */
  OPT_std_f2003 = 1250,                      /* -std=f2003 */
  OPT_std_f2008 = 1251,                      /* -std=f2008 */
  OPT_std_f2008ts = 1252,                    /* -std=f2008ts */
  OPT_std_f95 = 1253,                        /* -std=f95 */
  OPT_std_gnu = 1254,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1255, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1256, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1257,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1258,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1259, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1260, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1261,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1262,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1263,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1264, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1265, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1266,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1267,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1268, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1269, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1270,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1271, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1272, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1273, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1274,                     /* -std=legacy */
  OPT_symbolic = 1275,                       /* -symbolic */
  OPT_t = 1276,                              /* -t */
  OPT_time = 1277,                           /* -time */
  OPT_time_ = 1278,                          /* -time= */
  OPT_traditional = 1279,                    /* -traditional */
  OPT_traditional_cpp = 1280,                /* -traditional-cpp */
  OPT_trigraphs = 1281,                      /* -trigraphs */
  OPT_u = 1282,                              /* -u */
  OPT_undef = 1283,                          /* -undef */
  OPT_v = 1284,                              /* -v */
  OPT_version = 1285,                        /* -version */
  OPT_w = 1286,                              /* -w */
  OPT_wrapper = 1287,                        /* -wrapper */
  OPT_x = 1288,                              /* -x */
  OPT_z = 1289,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
